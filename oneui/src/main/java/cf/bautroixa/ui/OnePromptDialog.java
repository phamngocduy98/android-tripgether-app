...
public class OnePromptDialog extends OneDialog {
    @StringRes
    int inputHintResId = R.string.dialog_prompt_edit_hint;
    EditText editPrompt;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        editPrompt.setHint(inputHintResId);
    ...
    public void setInputHintResId(@StringRes int inputHintResId) {
        this.inputHintResId = inputHintResId;
    }
    ...
    public static class Builder {
        ...
        public Builder editHintText(@StringRes int hintText) {
            instance.setInputHintResId(hintText);
            return this;
        }
