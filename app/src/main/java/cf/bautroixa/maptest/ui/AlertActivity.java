            ...
            public void onClick(View v) {
                ...
                if (notification instanceof TripNotification) {
                    if (notification.getType().equals(Notification.TripType.USER_SOS_ADDED)) {
                        ...
                        NavigableHelper.navigate(AlertActivity.this, MainActivityPagerAdapter.Tabs.TAB_MAP, TabMapFragment.STATE_CHECKPOINT, Checkpoint.class.getSimpleName(), notification.getCheckpointRef().getId());
                    } else {
