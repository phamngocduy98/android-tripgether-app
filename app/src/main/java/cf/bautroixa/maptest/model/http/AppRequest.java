...
//    }
    ...
    public static Task<GeocodingResult> getGeocodingAddress(Context context, final LatLng latLng) {
            ...
            public void onResponse(@NotNull retrofit2.Call<GeocodingResponse> call, @NotNull retrofit2.Response<GeocodingResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        taskCompletionSource.setResult(new GeocodingResult(latLng, placeNameResponse));
                    } catch (Exception e) {
