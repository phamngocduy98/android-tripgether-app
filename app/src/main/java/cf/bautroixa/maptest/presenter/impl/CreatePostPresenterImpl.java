...
import cf.bautroixa.maptest.presenter.CreatePostPresenter;
import cf.bautroixa.maptest.ui.adapter.PostPlaceAdapter;
import cf.bautroixa.maptest.ui.adapter.viewholder.PlaceChipVH;
import cf.bautroixa.maptest.utils.FirebaseStorageHelper;
...
public class CreatePostPresenterImpl implements CreatePostPresenter {
    ...
    public void createPost(String body, Uri selectedImageUri, Bitmap selectedImageBitmap) {
        ...
        Tasks.whenAllSuccess(createPlaceTask, uploadImageTask).continueWithTask(new Continuation<List<Object>, Task<Void>>() {
            @Override
    ...
    public void addTrip() {
        ...
        for (int i = 0; i < checkpoints.size(); i++) {
            addPlace(new Place(checkpoints.get(i)));
        }
    }
