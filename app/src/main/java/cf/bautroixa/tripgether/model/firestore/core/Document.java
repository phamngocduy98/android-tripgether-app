...
public abstract class Document implements Serializable {
    ...
    @Exclude
    public void setListenerRegistration(long retryInterval, @Nullable final OnValueChangedListener initListener) {
    ...
    protected void finalize() throws Throwable {
        Timber.d(" successfully garbage collected documentId = %s", getId());
    }
